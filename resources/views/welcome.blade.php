...
<!--
  				...
  				<div class="row">
  					...
  					<div class="col-sm-4 pull-right">
  						<div class="top-social">
  							<ul>
  								<li>
  									<a href="{{ url('/user') }}" class="top-icon fa fa-user"></a>
  								</li>
  							</ul>
  						</div>
  					</div>
      ...
      --><!-- /#top-contact --><!-- <div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >企业网站模板</a></div> -->
...
<section id="contact" class="contact">
  <div class="contact-area">
    ...
    <div id="message-details" class="message-details">
      <div class="container">
        <form action="{{ url('/email') }}" method="post" id="myForm" class="message-form">
        {{ csrf_field() }}
          <div class="row">
            <div class="col-sm-6">
    ...
    <div class="container">
      <div class="row">
        <div id="tweet" class="tweet text-left">
          ...
          <div class="col-xs-4 about-tweet">
            <span class="tweet-icon"><a class="fa fa-user" href="{{ url('/user') }}"></a></span>
...
$('#googleMaps').gmap3({
 ...
 marker: {
   ...
   // options: { icon: {{ asset('images/mapicon.png') }} }
 }
});
}
