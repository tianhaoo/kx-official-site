  				...
  				<div class="row">
  					...
  					<div class="col-sm-4 pull-right">
  						<div class="top-social">
  							<ul>
  								<li>
  									<a href="{{ url('/admin') }}" class="top-icon fa fa-user"></a>
  								</li>
  							</ul>
  						</div>
  					</div>
...
<body class="header-fixed-top">
  		<header id="main-menu" class="main-menu">
              ...
              <nav id="menu" class="menu collapse navbar-collapse">
               <ul id="headernavigation" class="menu-list nav navbar-nav">
                <li class="active"><a href="{{url('/')}}" onclick="window.location.href='{{ url('/') }}'">Home</a></li>
                <li><a href="#about" onclick="window.location.href='#about';">About Us</a></li>
                <li><a href="#latest" onclick="window.location.href='#latest';">Latest Works</a></li>
                <li><a href="#activities" onclick="window.location.href='#activities';">Activities</a></li>
                <li><a href="#labs" onclick="window.location.href='#labs';">Labs</a></li>
  ...
  <section id="main-slider" class="main-slider carousel slide" data-ride="carousel">
   ...
   <div class="item item-2">
    ...
    <div class="carousel-caption">   
      <h3 class="carousel-title">Express Yourself With <span>科协</span></h3>
...
@foreach($abouts as $about)
    <div class="col-sm-4">
     <div class="item">
      <div class="item-top">
       <h3 class="item-title">{{ $about->title}}</h3>
       <h4 class="sub-title">{{ $about->sub_title }}</h4>
     </div><!-- /.item-top -->
     <p class="item-description">
       {{ $about->content }}
     </p>
     <a class="btn" href="{{ $about->link }}">
...
<section id="latest" class="portfolio text-center">
 <div class="container">
    ...
    @foreach($latests as $latest)
      <div class="item">
        <div class="item-image">
          <img src="storage/{{ $latest->image }}" alt="Portfolio Image">
        </div>
        <span class="item-title">{{ $latest->discription }}</span>
      </div>
    @endforeach
          ...
          <div class="item item-1">
            <div class="row">
              <div class="col-sm-6">
                ...
                <span class="sub-title">{{ $department->nick_name}} </span>
              </div>
              <div class="col-sm-6">
                <p class="item-description">
                  {{ $department->discription }}
                </p><!-- /.item-description -->
                <a class="btn" href="{{ $department->link }}">
                  <span class="btn-icon"><i class="fa fa-arrow-circle-right"></i></span>
                  More
                </a>
              </div>
           ...
           <div class="accordion">
            ...
            @foreach($activities as $activity)
              <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="heading{{$activity->id}}">
                  <h4 class="panel-title">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse{{$activity->id}}" aria-expanded="false" aria-controls="collapseOne">
                      {{ $activity->name}}
                    </a>
                  </h4>
                </div>
                <div id="collapse{{ $activity->id }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading{{$activity->id}}">
                  <div class="panel-body">
                    <span class="service-image"><img src="storage/{{ $activity->image }}" alt="Service Image"></span>
                    <!-- <span class="accordion-title">拆机讲座</span> -->
                    <p>
                      {{ $activity->doscription }}
                    </p>
                  </div>
                </div>
              </div>
...
<section id="labs" class="latest-post">
  <div class="container">
    <div class="post-area">
              ...
              <article class="post type-post">
                <div class="post-top">
                  <div class="post-thumbnail">
                   <img src="storage/{{ $lab->imgae }}" alt="post Image">
                 </div><!-- /.post-thumbnail -->  
                 <div class="post-meta">
                  <div class="entry-meta">
                    <span class="entry-date">
                      <time datetime="2015-01-15">Updated at {{ $lab->updated_at }}</time>
                    </span>
                  </div><!-- /.entry-meta -->
                </div><!-- /.post-meta -->
              </div><!-- /.post-top -->
              <div class="post-content">
                <h2 class="entry-title"><a href="{{ $lab->link }}">{{ $lab->name }}</a></h2>
                <p class="entry-text">
                 {{ $lab->discription }}
                </p>
                <a class="btn" href="{{ $lab->link }}">
                  <span class="btn-icon"><i class="fa fa-arrow-circle-right"></i></span>
                  Read More
                </a>
              </div><!-- /.post-content -->
...
<section id="contact" name="contact" class="contact">
  <div class="contact-area">
    ...
    <div id="message-details" class="message-details">
      <div class="container">
        <form action="{{ url('/message') }}" method="post" id="myForm" class="message-form">
        {{ csrf_field() }}
          <div class="row">
            <div class="col-sm-6">
              ...
              <input id="captcha" class="form-control" name="captcha" type="captcha" value="" size="30" aria-required="true" placeholder="captcha*" title="Captcha"  required >
            ...
            <div class="col-sm-6">
              <textarea id="message" class="form-control" name="message" cols="45" rows="6" aria-required="true" placeholder="Message" title="Message"  required></textarea>
      ...
      <div class="row">
        <div id="tweet" class="tweet text-left">
          <div class="col-xs-4 about-tweet">
            ...
            <span class="tweet-author">Official Website</span>
            <p class="tweet-details">
              苏州大学计算机科学与计术学院学生科技协会官方网站
            </p> <!-- /.tweet-details -->
          ...
          <div class="col-xs-4 about-tweet">
            ...
            <p class="tweet-details">
              如果有任何关于本网站的问题，请联系开发者：360726539@qq.com
            </p><!-- /.tweet-details -->
            <!-- <time datetime="PT2H">2 Hours Ago</time> -->
          </div>

          <div class="col-xs-4 about-tweet">
            <span class="tweet-icon"><a class="fa fa-user" href="{{ url('/admin') }}"></a></span>
            <span class="tweet-author">Management</span>
            <p class="tweet-details">
              后台管理
            </p><!-- /.tweet-details -->
            <!-- <time datetime="PT2H">2 Hours Ago</time> -->
  ...
  <div id="footer-bottom" class="footer-bottom text-center">
    <div class="container">
      <div id="copyright" class="copyright">
        &copy;  计算机科学与技术学院学生科技协会 -  by <a herf="https://tianhaoo.github.io">Tianhaoo</a>
      </div><!-- /#copyright -->
    </div>
  </div><!-- /#footer-bottom -->
</footer>
